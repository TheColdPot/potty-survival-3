data merge entity @s {Tags:[mandrake,dungeon_mob],IsBaby:true,ArmorItems:[{},{},{},{id:"minecraft:leather_helmet",components:{"minecraft:dyed_color":611340,"minecraft:unbreakable":{}}}],ArmorDropChances:[0f,0f,0f,0f],DeathLootTable:"empty"}
