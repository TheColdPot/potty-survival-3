...
scoreboard players operation @s received_magic_damage < max_int __number


scoreboard players operation @s health -= @s received_magic_damage
scoreboard players set min_health __number 0
scoreboard players operation @s health > min_health __number

function potty:combat/attack/display/special_magic_damage

scoreboard players reset @s received_magic_damage
