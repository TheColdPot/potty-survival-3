...
# 编号
scoreboard players set @s uibase_order 12
...
data modify entity @s text set value '[{"text":"Level: ","color":"gray"},{"text":"[","color":"dark_gray"},{"text":"400","color":"red"},{"text":"]","color":"dark_gray"}]'
data modify entity @s transformation.translation[1] set value 1.055f
