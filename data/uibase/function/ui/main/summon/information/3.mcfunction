...
# 编号
scoreboard players set @s uibase_order 13
...
data modify entity @s text set value '[{"text":"EXP: ","color":"gray"},{"text":"[","color":"dark_gray"},{"text":"||||||||","color":"aqua"},{"text":"||","color":"dark_gray"},{"text":"]","color":"dark_gray"},{"text":" (80/100)","color":"aqua"}]'
data modify entity @s transformation.translation[1] set value 1.05f
