...
# 编号
scoreboard players set @s uibase_order 6
...
data modify entity @s text set value '[{"text":"❖ Test6               ","color":"gold"}]'
data modify entity @s transformation.translation[1] set value 1.01f
