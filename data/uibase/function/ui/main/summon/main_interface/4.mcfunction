...
# 编号
scoreboard players set @s uibase_order 4
...
data modify entity @s text set value '[{"text":"❖ Warp                ","color":"gold"}]'
data modify entity @s transformation.translation[1] set value 1.03f
