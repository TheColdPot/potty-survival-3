...
data modify entity @s item set value {id:"golden_sword",count:1,components:{item_name:\
'[{"text":"             "},{"text":"匕首","color":"#fcc92f","bold":true,"italic":false}]'\
,lore:[\
'[""]',\
'[{"text":"专","color":"#fda900","italic":false},{"text":"属","color":"#feb71a","italic":false},{"text":"特","color":"#fec435","italic":false},{"text":"技","color":"#ffd24f","italic":false},{"text":" 突刺","color":"#ff1212","bold":true,"italic":false}]',\
'[{"text":"积攒蓄力后可向前冲刺刺向敌人","color":"gray","italic":false}]',\
'[{"text":"，段数越高，突刺伤害越高","color":"gray","italic":false}]',\
'[""]',\
'[""]',\
'[""]',\
'[""]',\
