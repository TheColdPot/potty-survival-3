data merge entity @s {Tags:[npc_forge_item,npc_item_new_summon],item:{id:"iron_sword",count:1},transformation:{scale:[0.2f,0.2f,0.2f],translation:[0.0f,2.5f,0.0f],left_rotation:[0f,1f,0f,1f],right_rotation:[0f,1f,0f,1f]},item_display:"gui",billboard:"fixed",glow_color_override:-14080,brightness:{block:15,sky:15}}
