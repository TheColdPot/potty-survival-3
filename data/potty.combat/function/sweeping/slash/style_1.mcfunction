...
execute as @s at @s anchored eyes positioned ^ ^ ^10 summon marker run function potty.combat:sweeping/slash/starter_deal
execute as @s at @s anchored eyes positioned ^ ^ ^10 summon marker run function potty.combat:sweeping/slash/ender_deal
