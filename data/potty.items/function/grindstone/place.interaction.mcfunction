...
summon item_display ~ ~ ~ {Tags:[new_summon,"grindstone_entity",grindstone_item], transformation:{left_rotation: [0f,0f,0f,1f],right_rotation:[0.7071f,0f,0f,0.7071f],scale:[1f,1f,1f],translation:[0f,-.1f,0f]}}
