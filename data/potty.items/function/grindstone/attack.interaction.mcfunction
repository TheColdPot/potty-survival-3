...
execute on passengers if entity @s[tag=grindstone_item] run data modify storage potty.items:constructor target set from entity @s item
...
execute on passengers if entity @s[tag=grindstone_item] run function potty.items:grindstone/remove_first_attachment
...
summon item ~ ~1 ~ {Tags:[grindstone_attachable,new_summon],Item:{id:"iron_nugget"}, Motion:[0d, .1d, 0d]}
