...
execute if score @s animation_frame matches 40 positioned ~ ~1 ~ run function potty.items:anvil/attach/particle_sphere
execute if score @s animation_frame matches 40 run playsound entity.ender_eye.death block @a
execute if score @s animation_frame matches 40 run function potty.items:anvil/attach/apply
