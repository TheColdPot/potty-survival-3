...
execute if score @s animation_frame matches 1..30 run particle block_crumble{block_state:{Name:"iron_block"}} ~ ~2 ~
...
execute if score @s animation_frame matches 2 run data merge entity @e[distance=..2,tag=anvil_attachable,limit=1] {transformation:{right_rotation:[0f,0f,0f,1f],scale:[1f,1f,1f]},interpolation_duration:25,start_interpolation:0}
execute if score @s animation_frame matches 35 run data merge entity @e[distance=..2,tag=anvil_attachable,limit=1] {transformation:{right_rotation:[0f,1f,0f,0f],scale:[0f,0f,0f],translation:[0f,0f,0f],left_rotation:[-.7071f,0f,0f,-.7071f]},interpolation_duration:5,start_interpolation:0}
