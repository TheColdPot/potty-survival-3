...
execute if score @s cleave_charge matches ..0 run title @s actionbar ["", [{"score": {"name": "*", "objective": "health"},"color":"red"}, "/", {"score": {"name": "*", "objective": "max_health"}}, {"text":" ❤"}], "   ", \
  \
  ["",{"text":"⚔ ","color":"dark_gray"}, "", [{"storage":"potty:actionbar","nbt":"bar_left","strikethrough":true,"color":"yellow"},{"storage":"potty:actionbar","nbt":"bar_emph","strikethrough":true,"color":"gold"},{"storage":"potty:actionbar","nbt":"bar_right","color":"dark_gray"}]], \
  \
  "   ",[{"score": {"name": "*", "objective": "mana"},"color":"aqua"}, "/", {"score": {"name": "*", "objective": "max_mana"}}, {"text":" Mana"}]]

execute if score @s cleave_charge matches 1 run title @s actionbar ["", [{"score": {"name": "*", "objective": "health"},"color":"red"}, "/", {"score": {"name": "*", "objective": "max_health"}}, {"text":" ❤"}], "   ", \
  \
...
execute if score @s cleave_charge matches 2 run title @s actionbar ["", [{"score": {"name": "*", "objective": "health"},"color":"red"}, "/", {"score": {"name": "*", "objective": "max_health"}}, {"text":" ❤"}], "   ", \
  \
  ["",{"text":"⚔ ","color":"white"}, "", [{"storage":"potty:actionbar","nbt":"bar_left","strikethrough":true,"color":"yellow"},{"storage":"potty:actionbar","nbt":"bar_emph","strikethrough":true,"color":"gold"},{"storage":"potty:actionbar","nbt":"bar_right","color":"dark_gray"}]], \
  \
  "   ",[{"score": {"name": "*", "objective": "mana"},"color":"aqua"}, "/", {"score": {"name": "*", "objective": "max_mana"}}, {"text":" Mana"}]]

execute if score @s cleave_charge matches 3.. run title @s actionbar ["", [{"score": {"name": "*", "objective": "health"},"color":"red"}, "/", {"score": {"name": "*", "objective": "max_health"}}, {"text":" ❤"}], "   ", \
  \
